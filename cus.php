...
<div class="form-group">
          ...
          <div class="row">
            <div class="col-md-6">
			  ...
			  <div class="form-group">
                ...
                <input type="text" name="id_no"  class="form-control pull-right"  required>
                  </div>
                  </div> 
              </div>
              </div>
  ...
  <div class="box box-warning">
        <div class="box-header with-border">
          <h3 class="box-title">Guaranter ඇපකරු</h3>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="cus_name1" required >
                  </div>
                  </div>
				</div>
			   ...
			   <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone_no1" data-inputmask='"mask": "(999)-9999999"' data-mask>
                  </div>
                  </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="birthday1"  class="form-control pull-right" data-inputmask='"mask": "9999-99-99"' data-mask >
                  </div>  
                  </div>
				</div>
			  ...
			  <div class="form-group">
                ...
                <input type="text" name="id_no1"  class="form-control pull-right"  required>
                  </div>
                  </div> 
              </div>
              </div>
          ...
          <div class="row">
            <div class="col-md-6">
			  ...
			  <div class="form-group">
                ...
                <input type="text" name="address1" class="form-control pull-right"  >
                  </div>
                  </div> </div>
              </div>
              </div>
