...
?>
<body class="hold-transition skin-red layout-top-nav sidebar-collapse">
<?php
...
To:<input type="text" style="width:223px; padding:4px;" name="d2" id="datepickerd"  value="" autocomplete="off"/>
 ...
 <a href="stock.php?type=1"><button class="btn btn-info" style="width: 123px; height:35px; margin-top:-8px;margin-left:8px;" >
